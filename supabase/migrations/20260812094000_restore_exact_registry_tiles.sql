...
as $$
  with bounds as (
    ...
    select
      r.id, r.kind, r.name, r.operator, r.status, r.technology, r.generation_group,
      r.net_capacity_mw, r.storage_energy_mwh, r.source_url,
      extensions.st_asmvtgeom(
        extensions.st_transform(r.geometry, 3857), b.geom_3857, 4096, 64, true
      ) as geom
