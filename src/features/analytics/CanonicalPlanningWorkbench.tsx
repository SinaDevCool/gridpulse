...
export function CanonicalPlanningWorkbench() {
  ...
  return (
    <section className="data-panel" aria-labelledby="canonical-planning-title">
      ...
      <p>Submit a versioned contract exported from a project or integration. The browser validates the transport shape; all electrical, workload, uncertainty, replay, and economic calculations run in the canonical backtest engine.</p>
